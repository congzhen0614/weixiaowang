<template>
	<div class="mine-train">
		<!-- 头部 -->
		<section class="mine-train-top underline">
			<div class="back-icon" @click="goBack()">
				<img :src="backIconSrc">
			</div>
			<p class="title">我的培训</p>
		</section>
		<!-- 列表 -->
		<ul v-if="listData && listData.length" class="train-list">
			<li v-for="(item, index) in listData" class="train-item">
				<div class="list-body">
					<div class="left-part">
